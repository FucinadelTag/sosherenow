<template>
    <span>
        ...
        <h2 class="title is-2">In auto</h2>
        ...
        <h2 class="title is-2">In montagna</h2>
        ...
        <h2 class="title is-2">In barca</h2>
