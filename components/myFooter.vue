      ...
      <div class="columns">
        <div class="column content">
          ...
          <section class>
            ...
            <vue-disqus
              shortname="www-sosherenow-it"
              v-bind:identifier="getIdentifier"
              v-bind:url="getAbsoluteUrl"
            ></vue-disqus>
          </section>
        </div>
        <div id="form" class="column">
          <p class="title is-4">{{$t(traduzioni.contatti.contattaci)}}</p>
          <p class="subtitle is-6">{{$t(traduzioni.contatti.scrivimessaggio)}}</p>
          <section>
            <form v-on:submit.prevent="submitForm($event)">
              <input
                ...
                id="url_redirect"
                name="url_redirect"
                value="https://www.solede.com/grazie"
              >
              <div class="field">
              ...
              <div class="field">
                ...
                <p class="control">
                  <textarea
                    ...
                    v-model="message"
                    name="message"
                    v-bind:placeholder="$t(traduzioni.contatti.messaggio)"
                  ></textarea>
                </p>
              </div>
        ...
        <div class="column has-text-centered">
          <div class="has-text-centered">
            <strong>Solede</strong>
            <br>Progetto di Fucina del Tag
            <br>Via Pastrengo 14
            <br>20159 Milano
